export default function ValueProposition() {
  return (
    <section className="w-full bg-white py-20 relative">
        <p className="w-px h-37.5 absolute bg-[#FFB201] right-[50%] top-28.75"></p>
        <p className="absolute left-[22%] w-[50%] top-11.25  h-px bg-[#FFB201]">

        </p>
      <div className="mx-auto max-w-7xl px-6 ">
        <div className="grid grid-cols-1 gap-1 md:grid-cols-2">
          {/* Left Heading */}
          <h2 className="max-w-md text-3xl font-bold leading-tight text-black md:text-4xl">
          ...
          {/* Right Content */}
          <div className="space-y-8 text-gray-700  pl-10">
